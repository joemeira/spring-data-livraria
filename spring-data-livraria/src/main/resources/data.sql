...
insert into tb_autor(autor_id, primeiro_Nome, ultimo_Nome, pais) values (3,'Leo', 'Tolstoi', 'Rússia');
insert into tb_autor(autor_id, primeiro_Nome, ultimo_Nome, pais) values (4,'Sérgio', 'Iudicibus', 'Brasil');
